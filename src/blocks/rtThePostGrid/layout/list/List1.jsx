import {
    ...
    MetaStyle_align,
    Content_wrap,
    Content_padding,ImgCol, ContentCol, Colgut, Titlea, Titletag
            ...
            <div className={`rt-row rt-content-loader layout2 list1 layout_parent tpg-even`}>
                {
                    data.length && data.map((post) => {
                        ...
                        return(
                            <>
                                <Colgut lay_sty={layout.value} css={content_wrap} className={`rt-col-md-${columns.desktop} rt-col-sm-${(columns.tablet == "24")? "2":columns.tablet} rt-col-xs-${(columns.mobile == "24")? "2":columns.mobile} list_layout one even-grid-item ${image.animation}`} data-id={post.id}>
